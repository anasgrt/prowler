...
|------|-------------|------|---------|:--------:|
| <a name="input_prowler_filter_region"></a> [prowler\_filter\_region](#input\_prowler\_filter\_region) | AWS region List for Prowler Security Assessment | `string` | `"eu-west-1"` | no |
